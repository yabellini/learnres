...
La descripción del curso enumera los contenidos, el orden y opcionalmente el tiempo involucrado en cubrir cada tema.  También suele mencionar las herramientas que se utilizarán para enseñar y los elementos que las y los estudiantes necesitan tener disponibles.
...
**Objetivo general:** Introducir a los asistentes en el control de versiones utilizando Git desde RStudio.
...
* Comprender los beneficios de un sistema de control de versiones automatizado.
* Comprender los conceptos básicos de cómo funcionan los sistemas de control de versiones automatizados.
* Entender que es un repositorio local y como se relaciona con los proyectos de RStudio.
* Entender que es un repositorio remoto y como se relaciona con GitHub.
* Comprender cómo usar Git con GitHub desde RStudio.
* Generar un proyecto con control de versiones desde cero.
* Agregarle control de versiones a un proyecto ya existente.
* Hacer stage y commit a un repositorio local.
* Hacer Push to or pull desde un repositorio remoto.
